...
class LocationManagerTests: XCTestCase {
    ...
    func testDeniedSoAlertForSettings() {
        ...
        locationManager.getLocation(completion: { (lat, long) in
    ...
    func testRequestingLocation() {
        ...
        locationManager.getLocation{ (latitude, longitude) in
            XCTAssert(latitude==LocationManagerTests.testLatitude&&longitude==LocationManagerTests.testLongitude, "Unexpected location returned from location manager")
        }
    }
